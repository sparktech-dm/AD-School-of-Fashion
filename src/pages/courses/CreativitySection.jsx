...
const CreativitySection = () => {
  ...
  return (
    <div className="relative bg-[#f0eee0] py-6 md:py-10 px-2 font-sans text-center">
      <h2 className="text-3xl md:text-5xl font-['Cormorant_Garamond'] font-bold text-[#79538a] mb-1 tracking-wide">
        Creativity born here
      </h2>

      <br />

      <p className="text-[18px] font-['Cormorant_Garamond'] md:text-[20px] leading-relaxed mb-4 text-[#79538a]">
      ...
      <button
        className="bg-[#79538a] text-white font-semibold py-2 px-6 rounded-full hover:bg-purple-800 transition duration-500"
