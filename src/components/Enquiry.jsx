...
export default function Enquiry() {
  ...
  <h2 className="font-extrabold font-cormorant text-4xl lg:text-6xl text-[#5a2d4b] leading-snug">
    Complete your training. Earn an industry-recognised certificate.
  </h2>
  <p className="italic font-bold font-cormorant text-3xl lg:text-3xl text-[#5a2d4b] mt-4 lg:mt-8">
    Step into the world of fashion with confidence!
          ...
          {/* Right Form */}
<div className="w-full max-w-md flex-1 px-4 py-6 sm:px-0 sm:py-0">
  ...
  <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
    ...
    <button
      type="submit"
      className="bg-[#58284b] text-white rounded-full py-5 sm:py-5 font-medium hover:bg-[#3f1935] transition text-lg"
    >
      Enquire Now
    </button>
