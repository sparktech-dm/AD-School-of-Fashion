...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[120vh] md:min-h-[800px] w-full overflow-x-hidden overflow-y-hidden bg-[#f0eee0] flex flex-col md:flex-row items-center justify-center pt-28">
      ...
      <div className="relative z-10 flex-[3] flex flex-col justify-center items-center md:items-start px-5 sm:px-8 md:px-10 lg:pl-32 xl:pl-60 2xl:pl-80 pr-10 h-auto md:h-full">
        <div className="w-full">
          <h1
            className="font-cormorant text-5xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-7xl font-extrabold text-center md:text-left"
            style={{ color: "#5a2d4b" }}
          >
          ...
          <p
            className="italic font-bold font-cormorant mt-6 md:mt-4 text-4xl sm:text-3xl md:text-xl lg:text-2xl xl:text-4xl text-center md:text-left"
            style={{ color: "#5a2d4b" }}
          >
...
/>
      ...
      <img
        ...
        alt="Dress Sketch"
        className="absolute left-[-200px] w-44 sm:w-80 opacity-80 bottom-10 sm:bottom-0"
